export default {
  ...
  'form.address.label': '地址',
  'form.address.placeholder': '店铺地址',
  'form.date.label': '创建时间',
  'form.date.placeholder.start': '创建时间',
  ...
  'form.public.radio.car': '空闲中',
  'form.public.radio.carone': '已被使用',
  'form.public.radio.cartwo': '暂停使用',
  'form.public.radio.driver': '工作中',
  'form.public.radio.driverone': '休息中',
  'form.public.radio.drivertwo': '已离职',
  'form.public.radio.hide': '隐藏',
  'form.public.radio.show': '显示',
  'form.public.radio.status': '待审',
  'form.public.radio.statusone': '已审',
  'form.public.radio.statustwo': '审核失败',
